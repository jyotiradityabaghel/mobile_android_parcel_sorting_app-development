...
public class BottomNavigationView extends LinearLayout {
    ...
    public BottomNavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.labelTextSize = arr.getDimension(R.styleable.BottomNavigationView_label_textSize, 10);
        arr.recycle();
            ...
            for (int i = 0; i < length; i++) {
                ...
                if(this.isIconEnable){
                    ...
                    if(!this.isLabelEnable){
                        ...
                        params.height = RelativeLayout.LayoutParams.WRAP_CONTENT;//Utils.dip2px(this.context, 48);
                ...
                if(this.isLabelEnable){
                    ...
                    labelTextView.setTextColor(Color.parseColor("#4B5054"));
                    labelTextView.setTypeface(item.getTextViewStyle());
            ...
            for (int i = 0; i < itemLayoutList.size(); i++) {
                ...
                itemLayout.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        bottomViewItemSelected (itemLayout, position, currentPosition);
    ...
    public void bottomViewItemSelected (View itemLayout, int position, int oldSelectedPosition){
        // set item to default first
        resetActiveItemToDefault(itemLayoutList, oldSelectedPosition);
    ...
    public void resetActiveItems (int selectedPOsition) {
        // set item to default first
        resetActiveItemToDefault(itemLayoutList, selectedPOsition);
    }
    ...
    private void resetLabelToDefault(List<View> layouts, int position) {
        ...
        label.setTextColor(Color.parseColor("#4B5054"));
    }
    ...
    private void setLabelToActive(View layout, int position){
        ...
        label.setTextColor(Color.parseColor("#0089BC"));
    }
